...
const Footer = () => {
    return (
        <div className='bg-[#f3f3f3] flex justify-center px-4 py-4 pt-10 pb-10'>
            <div className='w-full max-w-6xl bg-white rounded-[24px] shadow-sm border border-gray-200 py-8 px-3 text-center '>
                ...
                <p className='text-gray-500 text-sm max-w-xl mx-auto'>
                    AI-powered interview prepairation platform designed to improve communication skills,technical depth and professional confidence.
                </p>
            </div>
